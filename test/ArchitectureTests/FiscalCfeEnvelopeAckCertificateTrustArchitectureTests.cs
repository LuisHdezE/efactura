...
public sealed class FiscalCfeEnvelopeAckCertificateTrustArchitectureTests
{
    ...
    public void Documentation_bounds_PKI_Uruguay_trust_without_overclaiming_DGI_identity_or_readiness()
    {
        ...
        Assert.Contains("X.509 trust-chain/trust-anchor validation for DGI ACK certificates", checkpoint, StringComparison.Ordinal);
        Assert.Contains("OCSP/CRL and DGI-specific certificate habilitation verification", checkpoint, StringComparison.Ordinal);
