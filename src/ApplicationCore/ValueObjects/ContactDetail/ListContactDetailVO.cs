...
{
    public class ListContactDetailVO : IEquatable<ListContactDetailVO>
    {
        public ListContactDetailVO(long customerId, long contactTypeId, string contactValue)
        {
        ...
        public bool Equals(ListContactDetailVO other)
        {
        ...
        {
            return Equals(obj as ListContactDetailVO);
        }
