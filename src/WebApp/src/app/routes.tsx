...
export const shellNavigationItems: ShellNavigationItem[] = [
  ...
  },
  {
    ...
    label: 'Inventario',
    icon: '▥',
    navigationGroup: 'Inventario y Compras'
  },
  {
    webId: 'WEB-008',
    state: 'planned',
  ...
  },
  {
    webId: 'WEB-017',
    state: 'planned',
    label: 'Reportes y Calendario fiscal',
    icon: '▧',
    navigationGroup: 'Reportes'
  },
  {
    webId: 'WEB-018',
    state: 'planned',
    label: 'Auditoría / Seguridad / Configuración',
    icon: '⚙',
