...
[Migration("20260914123000_V1FiscalCfeDocumentResponseCertificateTrust")]
public sealed class V1FiscalCfeDocumentResponseCertificateTrust : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            name: "v1_fiscal_cfe_document_response_certificate_trust_validations",
            columns: table => new
            {
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_v1_fiscal_cfe_document_response_certificate_trust_validations", x => x.Id);
                table.ForeignKey(
                    name: "FK_v1_fcdrctv_signature_verification",
                    column: x => x.SignatureVerificationId,
                    principalTable: "v1_fiscal_cfe_document_response_signature_verifications",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Restrict);
                table.ForeignKey(
                    name: "FK_v1_fcdrctv_consultation",
                    column: x => x.ConsultationId,
                    principalTable: "v1_fiscal_cfe_document_response_consultations",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Restrict);
                table.ForeignKey(
                    name: "FK_v1_fcdrctv_ack_observation",
                    column: x => x.AckObservationId,
                    principalTable: "v1_fiscal_cfe_envelope_ack_observations",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Restrict);
                table.ForeignKey(
                    name: "FK_v1_fcdrctv_submission",
                    column: x => x.SubmissionId,
                    principalTable: "v1_fiscal_cfe_envelope_submissions",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Restrict);
                table.ForeignKey(
                    name: "FK_v1_fcdrctv_envelope",
        ...
        migrationBuilder.CreateIndex(
            name: "UX_v1_fcdrctv_operation",
            table: "v1_fiscal_cfe_document_response_certificate_trust_validations",
            columns: new[] { "OrganizationId", "OperationId" },
            unique: true);
        migrationBuilder.CreateIndex(
            name: "IX_v1_fcdrctv_signature_verification",
            table: "v1_fiscal_cfe_document_response_certificate_trust_validations",
            column: "SignatureVerificationId");
        migrationBuilder.CreateIndex(
            name: "IX_v1_fcdrctv_consultation",
            table: "v1_fiscal_cfe_document_response_certificate_trust_validations",
            column: "ConsultationId");
        migrationBuilder.CreateIndex(
            name: "IX_v1_fcdrctv_ack_observation",
            table: "v1_fiscal_cfe_document_response_certificate_trust_validations",
            column: "AckObservationId");
        migrationBuilder.CreateIndex(
            name: "IX_v1_fcdrctv_submission",
            table: "v1_fiscal_cfe_document_response_certificate_trust_validations",
            column: "SubmissionId");
        migrationBuilder.CreateIndex(
            name: "IX_v1_fcdrctv_envelope",
            table: "v1_fiscal_cfe_document_response_certificate_trust_validations",
            column: "EnvelopeId");
    }

    protected override void Down(MigrationBuilder migrationBuilder) =>
        migrationBuilder.DropTable(name: "v1_fiscal_cfe_document_response_certificate_trust_validations");
}
