...
Reconciled against: `main@cb85d9516756117e9ca803a0e4f7703aad3edd2c`
...
`API-REF-005 listFiscalDocumentTypes` and `API-REF-006 listInvoiceIndicators` were added by W1.1C on this baseline. They are fiscal-issuance references and do not expand the supplier-master v1 scope.
