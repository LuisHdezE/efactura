...
Status: `FULLY_RECONCILED / W1_2_IDENTITY_ACCESS_IMPLEMENTED`
...
Current implemented HTTP operations: **51**.

Current non-implemented operation IDs: **143**.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | Identity + Organization + Reference Data | 30 | 17 | 13 | 0 | 13 | 56.67% |
...
`13 + 4 + 24 + 19 + 32 + 21 + 30 = 143`

`141 MISSING_HTTP + 2 CONTRACT_COLLISION = 143 non-implemented IDs`

## Family-to-wave allocation

| Wave | API families | Count | Current implemented families/operations |
|---:|---|---:|---|
| 1 | `IAM-001..011`, `ORG-001..010`, `REF-001..008`, `CAT-009` | 30 | `IAM-001`, `IAM-011`, `ORG-001..006`, `REF-001..008`, `CAT-009` |
...
W1.1 Reference Data is complete and W1.2 implements `API-IAM-001 getCurrentActor` plus `API-IAM-011 listPermissions` by projecting the existing actor context and canonical application permission set. Wave 1 proceeds next to W1.3 for `API-IAM-006..009` roles read/write.
