...
Status: `FULLY_RECONCILED / W1_1B_COUNTRY_CURRENCY_CATALOGS`
...
Current implemented HTTP operations: **45**.

Current non-implemented operation IDs: **149**.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | Identity + Organization + Reference Data | 30 | 11 | 19 | 0 | 19 | 36.67% |
...
`19 + 4 + 24 + 19 + 32 + 21 + 30 = 149`

`147 MISSING_HTTP + 2 CONTRACT_COLLISION = 149 non-implemented IDs`

## Family-to-wave allocation

| Wave | API families | Count | Current implemented families/operations |
|---:|---|---:|---|
| 1 | `IAM-001..011`, `ORG-001..010`, `REF-001..008`, `CAT-009` | 30 | `ORG-001..006`, `REF-001..004`, `CAT-009` |
...
W1.1A implements `API-REF-002` and `API-REF-003`; W1.1B now implements `API-REF-001` and `API-REF-004` after closing their country/currency source prerequisites. `API-REF-005..008` retain their audited prerequisites and proceed through W1.1C/W1.1D before any additional Reference Data routes are exposed.
